...
import { runSeed } from '@/infrastructure/db/seed'
...
export async function bootstrap() {
  try {
    ...
    if (provider === 'sqlite') {
      ...
      await migrateSqlite(db, { migrationsFolder: './src/infrastructure/db/migrations/sqlite' })
      ...
      await migratePg(db, { migrationsFolder: './src/infrastructure/db/migrations/pg' })
